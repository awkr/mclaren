...
void destroy_gizmo(Gizmo *gizmo, MeshSystemState *mesh_system_state, VkContext *vk_context) {
  destroy_geometry_vma(mesh_system_state, vk_context, &gizmo->cube_geometry);
  destroy_geometry_vma(mesh_system_state, vk_context, &gizmo->ring_geometry);
  destroy_geometry_vma(mesh_system_state, vk_context, &gizmo->arrow_geometry);
  destroy_geometry_vma(mesh_system_state, vk_context, &gizmo->axis_geometry);
}
